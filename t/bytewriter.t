...
use BBC::HDS::Bootstrap::ByteWriter;

sub writer() { BBC::HDS::Bootstrap::ByteWriter->new }
...
is( writer->write64( ( 0x41424344 << 32 ) | 0x45464748 )->data,
  'ABCDEFGH', 'write64' );
is( writer->write4CC( 'ab' )->data, 'ab  ', 'write4CC4CC4CC4CC' );

is( writer->writeZs( 'a', 'bb', 'ccc' )->data,
  "\x03a\0bb\0ccc\0", 'writeZs' );
