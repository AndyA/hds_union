...
package org.osmf.net.httpstreaming.f4f {
  ...
  internal class BoxParser extends EventDispatcher {
    ...
    /**
		 ...
		 */
    public
    function init(ba: ByteArray) : void {
      _ba = ba;
      _ba.position = 0;
    }
    ...
    /**
		 ...
		 */
    public
    function getNextBoxInfo() : BoxInfo {
    ...
    /**
		 ...
		 */
    public
    function readFragmentRandomAccessBox(bi: BoxInfo) : AdobeFragmentRandomAccessBox {
      var afra: AdobeFragmentRandomAccessBox = new AdobeFragmentRandomAccessBox();
      parseAdobeFragmentRandomAccessBox(bi, afra);
      return afra;
    }
    ...
    /**
		 ...
		 */
    public
    function readAdobeBootstrapBox(bi: BoxInfo) : AdobeBootstrapBox {
      var abst: AdobeBootstrapBox = new AdobeBootstrapBox();
    ...
    /**
		 ...
		 */
    private
    function readBytesToUint(length: uint) : uint {
      if (_ba == null || _ba.bytesAvailable < length) {
        CONFIG::LOGGING {
          logger.error("not enough length for readUnsingedByte");
          logger.error("******* probable cause: malformed BOOTSTRAP data");
    ...
    //
    private
    function parseBox(boxInfo: BoxInfo, box: Box) : void {
    ...
    private
    function parseFullBox(boxInfo: BoxInfo, fullBox: FullBox) : void {
    ...
    private
    function parseAdobeBootstrapBox(boxInfo: BoxInfo, abst: AdobeBootstrapBox) : void {
    ...
    private
    function parseAdobeSegmentRunTable(boxInfo: BoxInfo, asrt: AdobeSegmentRunTable) : void {
    ...
    private
    function parseAdobeFragmentRunTable(boxInfo: BoxInfo, afrt: AdobeFragmentRunTable) : void {
    ...
    private
    function parseFragmentDurationPair(fdp: FragmentDurationPair) : void {
      ...
      CONFIG::LOGGING {
        logger.debug("    firstFragment=" + fdp.firstFragment + "  duration=" + fdp.duration + "  durationAccrued=" + fdp.durationAccrued + "  discontinuityIndicator=" + fdp.discontinuityIndicator);
      }
    }

    private
    function parseAdobeFragmentRandomAccessBox(boxInfo: BoxInfo, afra: AdobeFragmentRandomAccessBox) : void {
    ...
    private
    function parseLocalRandomAccessEntry(lrae: LocalRandomAccessEntry, longOffsetFields: Boolean) : void {
    ...
    private
    function parseGlobalRandomAccessEntry(grae: GlobalRandomAccessEntry, longIdFields: Boolean, longOffsetFields: Boolean) : void {
      ...
      CONFIG::LOGGING {
        logger.debug("    time=" + grae.time + "   segment=" + grae.segment + "   fragment=" + grae.fragment + "   afraOffset=" + grae.afraOffset + "   offsetFromAfra=" + grae.offsetFromAfra);
      }
    }

    private
    function parseMediaDataBox(boxInfo: BoxInfo, mdat: MediaDataBox) : void {
